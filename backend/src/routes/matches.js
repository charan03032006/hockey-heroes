...
router.patch('/matches/:id',async(req,res)=>{
 const allowed=['status','current_period','clock_seconds','clock_running','started_at','ended_at','competition_rule','official_id','tiebreaker','shootout_home','shootout_away']; const patch={}; for(const k of allowed)if(req.body[k]!==undefined)patch[k]=req.body[k];
